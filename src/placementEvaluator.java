...
public class placementEvaluator {
    ...
    /**
     * method that validates whether candidate is allowed to be placed on grid
     * 
     * constraints:
     * - must have at least one overlap with the current grid
     * - rejects placements where a cell in grid is occupied by a different letter
     * - prevents word adjacency (words toching side by side)
     * - boundaries from start to end must be empty
     * 
